    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                ...
                <el-form-item>
                    <el-button type="primary" @click="handleAdd">发布新闻</el-button>
                </el-form-item>
        ...
        <!--发布新文件-->
        <el-dialog title="发布新闻" v-model="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
                ...
                <el-form-item label="参会人员">
                    <el-select v-model="formInline.region" placeholder="参会人员" multiple={true}
                                size="large">
...
<script>
    import newsDataList from '../../mock/data/newsList.json';
